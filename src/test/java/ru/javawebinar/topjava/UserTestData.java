...
public class UserTestData {
    ...
    public static final User USER_WITH_MEAL = new User(USER);
    static {
        USER_WITH_MEAL.setMeals(MealTestData.MEALS);
    }
    ...
    public static void assertMatchWithMeals(User actual, User expected) {
        ...
        assertThat(actual.getMeals()).usingElementComparatorIgnoringFields("user").isEqualTo(expected.getMeals());
    }
}
